...
namespace CustomControlsWPF
{
    ...
    public partial class TicketListViewItem : UserControl
    {
        ...
        public string Price
        {
            get
            {
                return (string)this.lblPrice.Content;
            }
            set
            {
                this.lblPrice.Content = value;
            }
        }
        public string FromTo
        {
            get
            {
                return (string)this.lblFromToTitle.Content;
            }
            set
            {
                this.lblFromToTitle.Content = value;
            }
        }
        public string FromToTime
        {
            get
            {
                return (string)this.lblFromToValue.Content;
            }
            set
            {
                this.lblFromToValue.Content = value;
            }
        }
        public string Duration
        {
            get
            {
                return (string)this.lblDurationValue.Content;
            }
            set
            {
                this.lblDurationValue.Content = value;
            }
        }
        public string Transfer
        {
            get
            {
                return (string)this.lblTransferValue.Content;
            }
            set
            {
                this.lblTransferValue.Content = value;
            }
        }
