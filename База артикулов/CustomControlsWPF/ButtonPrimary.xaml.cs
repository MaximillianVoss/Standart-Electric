...
namespace CustomControlsWPF
{
    ...
    public partial class ButtonPrimary : UserControl
    {
        ...
        private Dictionary<Colors, SolidColorBrush> brushes;

        public Double ButtonFontSize { set { btn.FontSize = value; } get { return btn.FontSize; } }

        public String Text { set { btn.Content = value; } get { return btn.Content.ToString(); } }
